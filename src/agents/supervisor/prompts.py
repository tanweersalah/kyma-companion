...
- If there is any YAML config , put the config in <YAML-NEW-DEPLOYMENT-CODE> </YAML-NEW-DEPLOYMENT-CODE> or <YAML-UPDATE-DEPLOYMENT-CODE> </YAML-UPDATE-DEPLOYMENT-CODE> block based on wether it is a new deployment or updating existing deployment.
"""
